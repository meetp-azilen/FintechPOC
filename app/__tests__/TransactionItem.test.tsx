...
describe('TransactionItem Component', () => {
  ...
  it('renders expense transaction correctly', () => {
    ...
    expect(getByText(new Date(expenseTransaction.date).toLocaleDateString())).toBeTruthy();
  ...
  it('renders income transaction correctly', () => {
    ...
    expect(getByText('October paycheck')).toBeTruthy();
    expect(getByText(new Date(incomeTransaction.date).toLocaleDateString())).toBeTruthy();
